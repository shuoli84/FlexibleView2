#
# Be sure to run `pod spec lint SLFlexibleView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of SLFlexibleView
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "shuo li" => "shuoli84@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'shuo li', 'other author'
